...
public:
    ...
    virtual void SetRowAttr(wxGridCellAttr *attr, int row, bool clear = false);
    virtual void SetColAttr(wxGridCellAttr *attr, int col, bool clear = false);
...
public:
    ...
    void     SetRowAttr(int row, wxGridCellAttr *attr, bool clear = false);
    void     SetColAttr(int col, wxGridCellAttr *attr, bool clear = false);
