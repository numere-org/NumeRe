...
void BI_splash()
{
	...
	cerr << std::setfill(' ') << std::setw((nLINE_LENGTH-80)/2+(nLINE_LENGTH%2)+1) << std::left << (char)186 << "    ~ ~ ~ ~ |__|  \\_____| |____/  |__|_|__| \\____) |__|\\__\\ \\____) ~ ~ ~ ~    " << std::setfill(' ') << std::setw((nLINE_LENGTH-80)/2+1) << std::right << (char)186 << endl;
