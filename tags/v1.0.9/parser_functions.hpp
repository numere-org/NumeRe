...
inline void printUnits(const string& sUnit, const string& sDesc, const string& sDim, const string& sValues, unsigned int nWindowsize)
    {
        cerr << "|     " << std::setfill(' ') << std::setw(11) << std::left << sUnit
