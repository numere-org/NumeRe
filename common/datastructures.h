...
enum WindowID
{
	...
	ID_MENU_PREVIEW_FILE_FROM_TREE,
	...
	ID_MENU_CREATE_LATEX_FILE_LINES_PRESERVED,
	ID_MENU_RUN_LATEX,
	ID_MENU_RUN_LATEX_LINES_PRESERVED,
