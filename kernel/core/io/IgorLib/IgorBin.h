...
// Use a 32 bit integer to replicate a 32 bit pointer type,
// which is not used by needed for correct structure alignment
typedef int32_t ptr32_t;
...
struct WaveHeader2
{
    ...
    ptr32_t next;                           // Used in memory only. Write zero. Ignore on read. //struct WaveHeader2** next;
    ...
    ptr32_t fileName;                       // Used in memory only. Write zero. Ignore on read. //Handle fileName;
    ...
    ptr32_t formula;                        // Used in memory only. Write zero. Ignore on read. //void** formula;
    ...
    ptr32_t waveNoteH;                      // Used in memory only. Write zero. Ignore on read. //Handle waveNoteH;
...
struct WaveHeader5
{
    ptr32_t next;              // link to next wave in linked list. //struct WaveHeader5** next;
    ...
    ptr32_t dFolder;            // Used in memory only. Write zero. Ignore on read. //struct DataFolder** dFolder;
    ...
    ptr32_t dataEUnits;                     // Used in memory only. Write zero. Ignore on read. //Handle dataEUnits;
    ptr32_t dimEUnits[MAXDIMS];             // Used in memory only. Write zero. Ignore on read. //Handle dimEUnits[MAXDIMS];
    ptr32_t dimLabels[MAXDIMS];             // Used in memory only. Write zero. Ignore on read. //Handle dimLabels[MAXDIMS];
    ...
    ptr32_t sIndices;                       // Used in memory only. Write zero. Ignore on read. //long** sIndices;
