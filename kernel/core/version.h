...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3857;
	#define RC_FILEVERSION 1,1,1,305
	#define RC_FILEVERSION_STRING "1, 1, 1, 305\0"
	static const char FULLVERSION_STRING [] = "1.1.1.305";
