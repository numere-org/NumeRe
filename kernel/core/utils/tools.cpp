...
void printLogo()
{
	...
	cerr << "                          .....             ...````..` ` ` ```.." << endl;
	Sleep(nSleepDur);
	cerr << "                    ..JMHWXXwXXWa.     ..`!.......`..WMHdM.  ....?." << endl;
	Sleep(nSleepDur);
	cerr << "                  .NHXWWWWXXZzXzwM, .?``....^.^.`.dMWK#NMMMc .......1." << endl;
	Sleep(nSleepDur);
	cerr << "                    ?NWWXX0XUZwwwwJ, ....^.....`.#WHHWWgMMM^  .`^...`.l" << endl;
	Sleep(nSleepDur);
	cerr << "                     MXWXkXXXVwwzulz   `..^`..,u4WXXHNddMMY^\"&,`....`..4" << endl;
	Sleep(nSleepDur);
	cerr << "                    JHXSUkXXXXvuwuw,b  `..Y5!! JHWWWKKNMMF     T,.`.^`^.h" << endl;
	Sleep(nSleepDur);
	cerr << "                   JHfXX0XXXwwwXuXuwJ.x5!`    .#KHHWddMMM!      .,.^....Jr" << endl;
	Sleep(nSleepDur);
	cerr << "                  .MXWXXX0XXwv0wXwXX|M        dWXUWNNMMMF        ....... N" << endl;
	Sleep(nSleepDur);
	cerr << "                 .#WWXW0XXwXvXuzwXdXXJ,      .#HHWWfNMM#          ;.^^^.`J" << endl;
	Sleep(nSleepDur);
	cerr << "                 MXWXXXw\\p1zwzuzudXZXnH      MKHHHWdMMM^          %.....`J" << endl;
	Sleep(nSleepDur);
	cerr << "                JWXWXXXfJM.wXwzwXXwudXJb    .NWXK#NMMMF          .:.....`J" << endl;
	Sleep(nSleepDur);
	cerr << "               JNWWZyZXjMMbjwuX0dXZXSXXJ,   MHHHdVgMM@.          ....^.^ F" << endl;
	Sleep(nSleepDur);
	cerr << "              .NWXWXXw|MMD 4kzuwXwXdXXXkW. .MKHNNddMM!           \\.^...`.F" << endl;
	Sleep(nSleepDur);
	cerr << "            .uMWWXWXXVJM5   NwwXXuXXdXyXSN #WWk#@NMM$           ,.....^`J" << endl;
	Sleep(nSleepDur);
	cerr << "           .t#WWVXXXX:M%    JKduZXXXVYVXkaedwV9MMHMM.          .`..^..`.$" << endl;
	Sleep(nSleepDur);
	cerr << "          .tJWWXWXZXrJF      4kwV1gMMMMHWHkWWXXXXXwkXwdWUu..  .!....^`.F" << endl;
	Sleep(nSleepDur);
	cerr << "         .D.HWWWXWXu.F        40.MMMMM#HWHWWkkyXVUTwwXXwruXXHG, `^..`.#" << endl;
	Sleep(nSleepDur);
	cerr << "        .8.NHXWXXWwiM          N,4MMMMFHkHkWXXSkJM@?!&wXwzuZSVXMa. ..M." << endl;
	Sleep(nSleepDur);
	cerr << "       .@j8HWXWXXXrJ3          .NA,Y4#dHWWWWSXX\\MB    JKuXuXXWWHKH..#." << endl;
	Sleep(nSleepDur);
	cerr << "       #i@dWWWXWZZ.F`           .NSj#dWWVWkkyXrJM`     Nw0XXWWHWQMMM`" << endl;
	Sleep(nSleepDur);
	cerr << "      J3PdHWWWXZwj#.             .hMdHWHWWXXkf.Mt     .#XXSXWKHBdMMF" << endl;
	Sleep(nSleepDur);
	cerr << "      h8dWkWkWX0jH.               J#dWUfXWSXXjMF      JuXWXWWWKdMMM" << endl;
	Sleep(nSleepDur);
	cerr << "     .EdWWkWXW3.B.               .MkHWWWXXXW\\MP     .HuZZZWWHHKMM#!" << endl;
	Sleep(nSleepDur);
	cerr << "     JkWWHXYq&#^`               .MHWUkXWXXXrJ#   ..WwXXXXXWWVhdM\"" << endl;
	Sleep(nSleepDur);
	cerr << "     JgJggMMMF                 .MKdWWWXWSyV.M..JW0wrzXZVTWggM#=" << endl;
	Sleep(nSleepDur);
	cerr << "     JMMMMM#4                  MMdHkHWXXXSiM m00uwXwuXn?MMM\"" << endl;
	Sleep(nSleepDur);
	cerr << "     .MMMN#gJr                JMNdHWWWXXX\\JN34ZwXwwuwXXXnd." << endl;
	Sleep(nSleepDur);
	cerr << "      WMMMMNMN.              JMMqHHWXSSyrJMF.,WwwvwwXXZWWHHQN.." << endl;
	Sleep(nSleepDur);
	cerr << "      .MMMMMMMN.            .MNdHWHkWXXYJM#.+li4JwzXdZXWWWbNMMMMMa&" << endl;
	Sleep(nSleepDur);
	cerr << "       .MMMMMMMMN&..        MM#WWWVXWSfJMM +Ov?.MxXXXXWWfKdMMMMMMMM.`" << endl;
	Sleep(nSleepDur);
	cerr << "        .4MMMMMMMMNMWHMHHH\\MM#QHWXWXYuMM#:?1JM5`` .WkyVWWWMMMMMMMM@." << endl;
	Sleep(nSleepDur);
	cerr << "          .WMMMMMMMMMNN#HWlWNUKTUqJMMMM5.xY3``       TWkBMMMMMMMM5`" << endl;
	Sleep(nSleepDur);
	cerr << "            .\"MMMMMMMMMNNKHhdMMMMMMMMH97!`               ?T\"MH9:!" << endl;
	Sleep(nSleepDur);
	cerr << "                ?T\"MMMMMMN#NgmVMBY:!`     " << std::setfill((char)196) << std::setw(37) << (char)196 << endl;
	Sleep(nSleepDur);
