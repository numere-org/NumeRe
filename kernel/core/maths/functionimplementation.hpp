...
mu::Array parser_rint(const mu::Array&);
...
mu::Array parser_exp(const mu::Array&);
mu::Array parser_abs(const mu::Array&);
mu::Array parser_sqrt(const mu::Array&);
mu::Array parser_sign(const mu::Array&);
mu::Array parser_log2(const mu::Array&);
mu::Array parser_log10(const mu::Array&);
mu::Array parser_ln(const mu::Array&);
mu::Array parser_log_b(const mu::Array&, const mu::Array&);
mu::Array parser_sin(const mu::Array&);
mu::Array parser_cos(const mu::Array&);
mu::Array parser_tan(const mu::Array&);
mu::Array parser_asin(const mu::Array&);
mu::Array parser_acos(const mu::Array&);
mu::Array parser_atan(const mu::Array&);
mu::Array parser_sinh(const mu::Array&);
mu::Array parser_cosh(const mu::Array&);
mu::Array parser_tanh(const mu::Array&);
mu::Array parser_asinh(const mu::Array&);
mu::Array parser_acosh(const mu::Array&);
mu::Array parser_atanh(const mu::Array&);
