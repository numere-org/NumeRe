...
Settings::Settings() : FileSystem()
{
    ...
    m_settings[SETTING_B_DEFPAGERELNOTES] = SettingsValue(false, SettingsValue::SAVE | SettingsValue::IMMUTABLE);
    m_settings[SETTING_B_ALWAYSDEFPAGE] = SettingsValue(true, SettingsValue::SAVE | SettingsValue::IMMUTABLE);
    m_settings[SETTING_B_POINTTOERROR] = SettingsValue(true, SettingsValue::SAVE | SettingsValue::IMMUTABLE);
    ...
    m_settings[SETTING_S_WINDOWSIZE] = SettingsValue("{}", SettingsValue::SAVE | SettingsValue::IMMUTABLE | SettingsValue::HIDDEN);
    m_settings[SETTING_B_SAVESASHS] = SettingsValue(false, SettingsValue::SAVE | SettingsValue::IMMUTABLE);
    m_settings[SETTING_B_SAVEWINDOWSIZE] = SettingsValue(false, SettingsValue::SAVE | SettingsValue::IMMUTABLE);
    ...
    m_settings[SETTING_B_SHOWQMARKS] = SettingsValue(true, SettingsValue::SAVE | SettingsValue::IMMUTABLE);
