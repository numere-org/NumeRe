...
void NumeReKernel::defineFunctions()
{
    ...
    _parser.DefineFun(_nrT("xor"), parser_xor, true);                                 // xor(x,y,z,...)
    ...
    _parser.DefineFun(_nrT("clock"), parser_clock, false);                            // clock()
    ...
    _parser.DefineFun(_nrT("ivl"), parser_ivl, true);                                 // ivl(x,x0,x1,lb,rb)
